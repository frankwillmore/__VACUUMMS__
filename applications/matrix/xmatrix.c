...
//printf("x\n");
      ...
      // accept/reject move
      cross_value =2 * the_matrix[i&255][j&255][k&255] * the_matrix[new_i&255][new_j&255][new_k&255] 
                  / (the_matrix[i&255][j&255][k&255] + the_matrix[new_i&255][new_j&255][new_k&255]); 

//printf("cross:  %lf\tmax:  %lf \n", cross_value, Dmax);

      if ((rand()*rand_step*Dmax)<cross_value) { i=new_i; j=new_j; k=new_k; }
